...
def _svg_donut(segments, size=180, stroke_width=32):
    """Generate an SVG donut chart. segments: list of (color, pct)"""
    cx = size // 2
    cy = size // 2
    ...
    for color, pct in segments:
        ...
        offset -= dash
    return f'<svg width="{size}" height="{size}" viewBox="0 0 {size} {size}">{"".join(circles)}</svg>'
...
def enhance_02(body):
    ...
    PIE_SVG = _svg_donut([('#8B0000', 40), ('#c41e3a', 25), ('#d44', 20), ('#f55', 10), ('#faa', 5)])
    PIE = f'''<div class="viz-title">资源分配比例</div><div class="pie-wrap"><div class="pie">{PIE_SVG}</div><div class="pie-legend"><div class="p-leg"><span class="p-dot" style="background:#8B0000"></span>人力 40%</div><div class="p-leg"><span class="p-dot" style="background:#c41e3a"></span>投放 25%</div><div class="p-leg"><span class="p-dot" style="background:#d44"></span>内容 20%</div><div class="p-leg"><span class="p-dot" style="background:#f55"></span>工具 10%</div><div class="p-leg"><span class="p-dot" style="background:#faa"></span>其他 5%</div></div></div>'''
...
def enhance_03(body):
    ...
    PIE_SVG = _svg_donut([('#8B0000', 30), ('#c41e3a', 25), ('#d44', 20), ('#f55', 15), ('#faa', 10)])
    PIE = f'''<div class="viz-title">内容团队时间分配</div><div class="pie-wrap"><div class="pie">{PIE_SVG}</div><div class="pie-legend"><div class="p-leg"><span class="p-dot" style="background:#8B0000"></span>内容策划 30%</div><div class="p-leg"><span class="p-dot" style="background:#c41e3a"></span>拍摄制作 25%</div><div class="p-leg"><span class="p-dot" style="background:#d44"></span>账号运营 20%</div><div class="p-leg"><span class="p-dot" style="background:#f55"></span>数据分析 15%</div><div class="p-leg"><span class="p-dot" style="background:#faa"></span>投放优化 10%</div></div></div>'''
...
def enhance_04(body):
    ...
    PIE_SVG = _svg_donut([('#8B0000', 35), ('#c41e3a', 12), ('#d44', 30), ('#f55', 23)])
    PIE = f'''<div class="viz-title">错铜手镯成本占比</div><div class="pie-wrap"><div class="pie">{PIE_SVG}</div><div class="pie-legend"><div class="p-leg"><span class="p-dot" style="background:#8B0000"></span>银料 35%</div><div class="p-leg"><span class="p-dot" style="background:#c41e3a"></span>铜料 12%</div><div class="p-leg"><span class="p-dot" style="background:#d44"></span>人工 30%</div><div class="p-leg"><span class="p-dot" style="background:#f55"></span>其他 23%</div></div></div>'''
...
def enhance_05(body):
    ...
    PIE_SVG = _svg_donut([('#8B0000', 40), ('#c41e3a', 25), ('#d44', 20), ('#f55', 15)])
    PIE = f'''<div class="viz-title">年度风险预算分配</div><div class="pie-wrap"><div class="pie">{PIE_SVG}</div><div class="pie-legend"><div class="p-leg"><span class="p-dot" style="background:#8B0000"></span>预防投入 40%</div><div class="p-leg"><span class="p-dot" style="background:#c41e3a"></span>应急响应 25%</div><div class="p-leg"><span class="p-dot" style="background:#d44"></span>保险覆盖 20%</div><div class="p-leg"><span class="p-dot" style="background:#f55"></span>储备金 15%</div></div></div>'''
...
def enhance_06(body):
    ...
    BUDGET_SVG = _svg_donut([('#8B0000', 35), ('#c41e3a', 20), ('#d44', 20), ('#f55', 15), ('#faa', 10)])
    BUDGET = f'''<div class="viz-title">首年预算分配</div><div class="pie-wrap"><div class="pie">{BUDGET_SVG}</div><div class="pie-legend"><div class="p-leg"><span class="p-dot" style="background:#8B0000"></span>产品开发 35%</div><div class="p-leg"><span class="p-dot" style="background:#c41e3a"></span>内容投放 20%</div><div class="p-leg"><span class="p-dot" style="background:#d44"></span>物流仓储 20%</div><div class="p-leg"><span class="p-dot" style="background:#f55"></span>平台费用 15%</div><div class="p-leg"><span class="p-dot" style="background:#faa"></span>应急储备 10%</div></div></div>'''
